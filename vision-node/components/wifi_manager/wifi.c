                                ...
                                int32_t event_id, void* event_data)
{
    if(event_base == WIFI_EVENT){
        /* This event is raised by esp_wifi_start() if it succeds */
...
esp_err_t wifi_init_sta(void)
{
    ...
    /*
        The following lines register the event handler for any WIFI event and the GOT_IP event from IP layer
    */
    ...
    // ESP_ERROR_CHECK(esp_wifi_set_ps(WIFI_PS_NONE)); // may help if stream lags
